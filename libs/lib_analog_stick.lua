...
function NewLeftStick( Props )
		...
		Group.Border = display.newImage("images/joystick/joystickmain1a.png")	
        Group:insert(Group.Border)
			
        -- Group.Thumb = display.newCircle(0,0,Props.thumbSize)
		-- for use images uncomment the line down and comment line up
		Group.Thumb = display.newImage("images/joystick/joystickmain1b.png") 
...
function NewRightStick( Props )
        ...
        -- for use images uncomment the line down and comment line up
        Group.Border = display.newImage("images/joystick/joystickmain2a.png")
        ...
        -- Group.Thumb = display.newCircle(0,0,Props.thumbSize)
        -- for use images uncomment the line down and comment line up
        Group.Thumb = display.newImage("images/joystick/joystickmain2b.png") 
        Group.Thumb.width = 56
        Group.Thumb.height = 57
        Group.Thumb:setFillColor  (Props.R,Props.G,Props.B,96)
        Group.Thumb:setStrokeColor(Props.R,Props.G,Props.B,255)
